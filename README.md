...
get the app created:
    ...
    $ heroku apps:create uap-clj-heroku
    Creating uap-clj-heroku... done, stack is cedar
    http://uap-clj-heroku.herokuapp.com/ | git@heroku.com:uap-clj-heroku.git
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@uap-clj-heroku.herokuapp.com/repl
